      ...
      <main className="pt-56 md:pt-52 pb-32 max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-stone max-w-none">
          ...
          <div className="space-y-6 text-sm text-stone-600 dark:text-stone-400 leading-relaxed">
            ...
            <h3 className="text-lg font-black uppercase tracking-tight text-stone-900 dark:text-stone-100">Content</h3>
            ...
            <h3 className="text-lg font-black uppercase tracking-tight text-stone-900 dark:text-stone-100">User Conduct</h3>
            ...
            <h3 className="text-lg font-black uppercase tracking-tight text-stone-900 dark:text-stone-100">Disclaimer</h3>
